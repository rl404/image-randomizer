...
func (c *client) GetByUsername(ctx context.Context, username string) (data *entity.User, code int, err error) {
...
func (c *client) Create(ctx context.Context, data entity.User) (*entity.User, int, error) {
